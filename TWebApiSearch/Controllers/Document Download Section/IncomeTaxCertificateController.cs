...
namespace TWebApiSearch.Controllers.Document_Download_Section
{
    ...
    public class IncomeTaxCertificateController : Controller
    {
        // GET: IncomeTaxCertificate
        private IncomeTaxCertificateBLL _objBLL = new IncomeTaxCertificateBLL();
        private DocumentDownloadSection _model = new DocumentDownloadSection();
        private List<ComboData> lComboData = new List<ComboData>();
        public ActionResult IncomeTaxCertificate()
        {
        ...
        public JsonResult GetTaxYear()
        {
            _objBLL = new IncomeTaxCertificateBLL();
            if (Session["UserName"] != null)
            {
                lComboData = _objBLL.LoadTaxYearDown();
            }
